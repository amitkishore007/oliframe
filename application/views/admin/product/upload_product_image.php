                ...
                <div class="page-content-wrapper">
                    ...
                    <div class="page-content">
                        <!-- BEGIN PAGE HEADER-->
                        <!-- BEGIN PAGE TITLE-->
                        <h1 class="page-title">Upload Product images</h1>
                        <!-- END PAGE TITLE-->
                        <!-- start  row -->
                                        ...
                                        <div class="actions">
                                            <!-- <div class="btn-group btn-group-devided" data-toggle="buttons"> -->
                                               <a href="<?php echo base_url('product'); ?>" name="back" class="btn btn-transparent dark btn-outline btn-circle btn-sm">
                                                ...
                                                <a href="<?php echo base_url('product/product_image') ?>" class="btn btn-transparent dark btn-outline btn-circle btn-sm">Upload Product image</a>
                                            <!-- </div> -->
                                        </div>
                                    </div>
